...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除C端用户信息管理编号为"' + ids + '"的数据项？')
        .then(function () {
